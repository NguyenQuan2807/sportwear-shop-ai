    ...
    >
      ...
      >
        <div className="mx-auto flex h-9 w-full max-w-[1840px] items-center justify-end gap-4 px-6 xl:px-8">
          {!user ? (
            <>
              <Link to="/login" className="header-utility-link">
                Đăng nhập
              </Link>
            </>
          ) : (
            ...
            >
              <button
                type="button"
                className="header-utility-user inline-flex"
                onFocus={() => setUtilityMenuOpen(true)}
              >
              ...
              {utilityMenuOpen ? (
                <div className="header-utility-dropdown">
                  <Link to={profilePath} className="header-dropdown-link">
                    Profile
                  </Link>
                  <Link to={orderPath} className="header-dropdown-link">
                    Orders
                  </Link>
      ...
      <div className="header-inner mx-auto flex h-[64px] w-full max-w-[1840px] items-center justify-between px-4 sm:px-6 xl:px-8 lg:grid lg:grid-cols-[1fr_auto_1fr]">
        ...
        <div className="hidden items-center justify-end gap-3 lg:flex">
          <form
            ...
            className="flex h-11 w-[220px] items-center gap-2 rounded-full border border-black/10 bg-white px-4 shadow-sm"
          >
